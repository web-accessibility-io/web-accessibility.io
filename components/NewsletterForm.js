    ...
    <div>
      ...
      <form className="flex flex-col sm:flex-row" onSubmit={subscribe}>
        <div>
          ...
          <input
            autoComplete="email"
            className="w-72 rounded-md bg-background px-4 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary-600"
            id="email-input"
            name="email"
            placeholder={
        ...
        <div className="mt-2 flex w-full rounded-md shadow-sm sm:ml-3 sm:mt-0">
          <button
            className={`w-full rounded-md bg-primary-500 px-4 py-2 font-medium text-white sm:py-0 ${
              subscribed ? 'cursor-default' : 'hover:bg-primary-500 dark:hover:bg-primary-400'
