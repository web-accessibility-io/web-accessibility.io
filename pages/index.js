...
export async function getStaticProps({ locale, defaultLocale, locales }) {
  ...
  return { props: { posts, locale, availableLocales: locales, stars } };
}

async function getGitHubStars() {
  try {
    const response = await fetch(
      'https://api.github.com/repos/web-accessibility-io/web-accessibility.io',
      {
        headers: {
...
export default function Home({ posts, locale, availableLocales, stars }) {
