...
lastmod: '2023-06-02'
draft: false
summary: "Make sure status messages are identified in code, so that assistive technologies can convey them to users."
authors: ['default']
---
...
* Status messages are not to be shown in a way that the screen reader understands and without receive [keyboard focus](/playbook/definitions#keyboard-focus).
