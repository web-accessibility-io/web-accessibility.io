...
lastmod: '2023-06-02'
draft: false
summary: "Do not use colour as the only way to convey any piece of information."
authors: ['default']
---
...
* Non-visual cues, which are programmatically available to assistive technologies, could be:
  ...
  * suitable ['Accessible Names'](/playbook/definitions#accessible-name) for elements;
  * ...
