---
title: 'Consistent feature names'
date: '2023-06-02'
lastmod: '2023-06-02'
draft: false
summary: "If a user interface component exists on multiple pages, make sure that the way it looks and the way it is named is consistent across pages."
authors: ['default']
---
...
* On your designs, specify what the '[Accessible Name](/playbook/definitions#accessible-name)' of each interactive component should be. This ensures that developers identify user interface components consistently to screen reader and speech-input users.
