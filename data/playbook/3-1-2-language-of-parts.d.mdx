...
lastmod: '2023-06-02'
draft: false
summary: "If the page has content in more than one language (for example, if a page in English has a button labelled in Welsh), identify the language of each part in code."
authors: ['default']
---
