...
Refer to the following sources for additional information on web accessibility guidelines:
...
This document is in beta. Help us improve its content or report any issues via the [GitHub repository](https://github.com/web-accessibility-io/web-accessibility.io).
