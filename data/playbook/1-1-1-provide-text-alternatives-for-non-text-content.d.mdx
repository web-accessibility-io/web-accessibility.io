...
lastmod: '2023-06-02'
draft: false
summary: "Learn how to ensure provide an alternative text description for non-text content. Make sure the description conveys the same message or functionality."
authors: ['default']
---
...
This section needs one or more examples. [Contribute or report issues via Github](https://github.com/web-accessibility-io/web-accessibility.io).
