const siteMetadata = {
  ...
  author: 'Tim Damen',
  headerTitle: { en: 'web accessibility', nl: 'web toegankelijkheid' },
  description: {
  ...
  siteRepo: 'https://github.com/web-accessibility-io/web-accessibility.io',
  siteLogo: '/static/images/logo.png',
  image: '/static/images/avatar.png',
  socialBanner: '/static/images/twitter-card.png',
  email: 'info@web-accessibility.io',
  github: 'https://github.com/web-accessibility-io',
  twitter: 'https://twitter.com/Twitter',
  youtube: 'https://www.youtube.com/channel/UCy3dM5AZsuAk8x4FNEpxzxA',
  ...
  analytics: {
    ...
    googleAnalyticsId: 'G-GMGW9X44KW', // e.g. UA-000000-2 or G-XXXXXXX
